...
public abstract class DaybookTransferExtension implements TransferExtension {
  private static final String SERVICE_ID = "Daybook";
  private static final String BASE_URL = "https://us-central1-diary-dev-env.cloudfunctions.net/post-daybook-dtp";

  private boolean initialized = false;

  private static final ImmutableList<String> SUPPORTED_DATA_TYPES = ImmutableList.of("PHOTOS");

  private DaybookPhotosImporter importer;
  ...
  public void initialize(ExtensionContext context) {
    ...
    importer = new DaybookPhotosImporter(monitor, client, mapper, jobStore, BASE_URL);
